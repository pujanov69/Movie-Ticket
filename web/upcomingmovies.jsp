...
<li class="current"><a href="Movies?action=upcoming" accesskey="n">Upcoming Movies</a></li>
...
<li class="current"><a href="Movies?action=upcoming" accesskey="u">Upcoming Movies</a></li>
