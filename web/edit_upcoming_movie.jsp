...
<html>
    <head>
        ...
        <title>Edit Upcoming Movies</title>
...
<li><a href="UserController?action=logout" accesskey="s">Logout</a></li>
         ...
         <form action= "EditUpcomingMoviesHandler" method="Post" enctype="multipart/form-data">
                    <table>
                        <tr><td colspan="2"><h1>Edit Now Showing Movies</h1></td></tr>
                        <input type="hidden" name="umid" value="${movie.umid}">
