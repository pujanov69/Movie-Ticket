...
<html>
    <head>
        ...
        <title>delete_or_edit_upcoming_movies</title>
...
<li><a href="UserController?action=logout" accesskey="s">Logout</a></li>
            ...
            <br>
    <h7><center>Upcoming Movies</center> </h7>
    <div class="movies">
            
            <c:forEach items="${upcoming_value}" var="items">
                ...
                <div class="first">
                    ...
                    <div class="img"><img src="<c:url value="uploads/${items.photo}"/>" width="300" height="290"></div>
                        ...
                        <a href="Movies?action=edit_upcoming_movies&&mid=${items.umid}">Edit Movie &nbsp;&nbsp;</a>
                        <a href="Movies?action=delete_upcoming_movie&&mid=${items.umid}">Delete Movie</a>       
                    </div><!--first-->
