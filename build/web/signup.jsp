...
<li class="current"><a href="signup.jsp" accesskey="r">Register</a></li>
            ...
            <div class="register">
                <form action= "UserController" method="Post">
                    <table>
                        <tr><td colspan="2"><h7>Sign-Up Form</h7></td></tr>
                        <tr><td>User Name:</td><td><input type="text" name="username" required/></td></tr>
                        <tr><td>Password:</td><td><input type="password" name="password" required/></td></tr>
                        <tr><td>Name:</td><td><input type="text" name="name" required></td></tr>
                        <tr><td>Gender:</td><td><input type="radio" name="gender" value="M" required/>Male &nbsp;
                        ...
                        <tr><td><input type="submit" class=btn name="submit" value="Signup"/></td></tr>
                    </table>
                </form>
